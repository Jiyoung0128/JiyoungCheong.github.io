...
OR_CI <- function(n11, n1d, n21, n2d, dist=c("z","t"), 
                  adjust=c("Agresti","Gart","Woolf"), alpha=0.01)
{
  dist <- match.arg(dist)
...
for (i in 1:length(methods)) {
  ...
  abline(v = 0.99, col = "red", lwd = 2, lty = 2)  # Dashed red line
  axis(1, at = 0.99, labels = "0.99", col = "red", col.axis = "red", tck = -0.02)  # Highlighted tick
